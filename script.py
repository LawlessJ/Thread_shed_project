...
daily_sales_clean = daily_sales_replaced.strip()
daily_transactions = daily_sales_clean.split(',')

daily_transactions_split = []
for items in daily_transactions:
  daily_transactions_split.append(items.split(':'))
#print(daily_transactions_split)
daily_transactions_split = [[x.strip() for x in list] for list in daily_transactions_split]
#print(daily_transactions_split)
...
#print(colors)
for each in colors:
  print("Thread Shed sold {count} threads of {color} today.".format(count=color_count(each),color=each))
